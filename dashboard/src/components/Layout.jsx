...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><line x1="9" y1="7" x2="15" y2="7"/><line x1="9" y1="11" x2="15" y2="11"/></svg>,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/oney', label: 'Oney',
        icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" ry="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>,
      },
      {
...
const DRAWER_NAV = [
  // En tete du tiroir : c'est la page qu'un nouveau doit trouver sans chercher.
  { to: '/guide', label: 'Guide', icon: NAV.find(n => n.to === '/guide').icon },
